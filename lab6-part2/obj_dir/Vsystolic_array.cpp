...
Vsystolic_array::Vsystolic_array(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , rst_accumulator_rdy{vlSymsp->TOP.rst_accumulator_rdy}
    , stream_out_rdy{vlSymsp->TOP.stream_out_rdy}
    , row_data_in_vld{vlSymsp->TOP.row_data_in_vld}
    , row_data_in_rdy{vlSymsp->TOP.row_data_in_rdy}
    , col_data_in_vld{vlSymsp->TOP.col_data_in_vld}
    , col_data_in_rdy{vlSymsp->TOP.col_data_in_rdy}
    , row_data_out_vld{vlSymsp->TOP.row_data_out_vld}
    , row_data_out_rdy{vlSymsp->TOP.row_data_out_rdy}
    , row_data_in{vlSymsp->TOP.row_data_in}
    , row_data_out{vlSymsp->TOP.row_data_out}
    , col_data_in{vlSymsp->TOP.col_data_in}
    , rootp{&(vlSymsp->TOP)}
{
