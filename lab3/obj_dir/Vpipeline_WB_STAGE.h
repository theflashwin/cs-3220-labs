...
class alignas(VL_CACHE_LINE_BYTES) Vpipeline_WB_STAGE final {
  public:
    ...
    VL_OUT8(__PVT__from_WB_to_AGEX,3,0);
    VL_OUT8(__PVT__from_WB_to_MEM,0,0);
    VL_INW(__PVT__from_MEM_latch,140,0,5);
