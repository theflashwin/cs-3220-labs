...
module DE_STAGE(
  ...
  localparam ALU_ALUOP = 3'd1;
  localparam ALU_OP1 = 3'd2;
  localparam ALU_OP2 = 3'd3;
  localparam ALU_WAIT = 3'd4;
  ...
  always @(negedge clk) begin
    ...
    if (reset) begin
      ...
      case (alu_state_reg)
        ...
        ALU_OP2: begin
          csr_alu_reg   <= 3'b000;
          alu_state_reg <= ALU_WAIT;
        end
        ALU_WAIT: begin
          if (csr_fu[2]) begin
            reg_file[`OP3_REG_IDX] <= op3_fu;
            csr_alu_reg   <= 3'b001;
            alu_state_reg <= ALU_IDLE;
          end
        end
        default: alu_state_reg <= ALU_IDLE;
      endcase
    end
